  ...
  return (
    <>
      ...
      <section
        ...
        className="py-20 bg-gradient-to-r from-primary to-blue-800 text-white"
      >
      ...
      {/* Volunteering */}
      <section id="volunteering" className="py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6">
      ...
      {/* Bottom CTA */}
      <section className="py-24 bg-gradient-to-r from-secondary to-orange-600 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
