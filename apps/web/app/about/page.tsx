...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* Values */}
      <section id="values" className="py-10 md:py-12 bg-background">
        <div className="w-full max-w-[1600px] mx-auto px-4 md:px-8">
      ...
      {/* What We Do */}
      <section id="what-we-do" className="py-10 md:py-12 bg-slate-50">
        <div className="w-full max-w-[1600px] mx-auto px-4 md:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="flex items-center justify-center gap-2 mb-4">
              <div className="w-12 h-1 bg-secondary rounded"></div>
      ...
      <section
        id="join-us"
        className="py-10 md:py-12 bg-gradient-to-r from-primary to-blue-800 relative overflow-hidden"
      >
        <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
        <div className="w-full max-w-[1600px] mx-auto px-4 md:px-8 text-center relative z-10">
          <motion.div
